...
var scenarios = []Scenario{
	...
	},
	{
		...
		Layer: LayerSim, Required: true, Source: sourcePlanB,
		Open: notLanded("B3 (§11, continuity and authority failure matrix)", "6"),
		Note: "internal/sim.TestReconnectMidStreamIsLossless proves the reattach contract; the Plan B row requires it inside the E2B pool failure matrix",
	},
	{
