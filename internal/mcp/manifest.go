...
var protocolOperations = []string{
	...
	"timer.list", "usage.get", "volume.archive", "volume.attach", "volume.create", "volume.detach", "volume.get", "volume.list", "volume.publish", "volume.publish.commit", "volume.remove", "ws.acl", "ws.claim", "ws.create", "ws.destroy", "ws.get", "ws.idle.mark", "ws.idle.policy", "ws.info", "ws.launch.record", "ws.lease", "ws.lease.cancel", "ws.lease.get", "ws.lease.renew", "ws.list", "ws.move", "ws.quarantine", "ws.quarantine.commit", "ws.ready", "ws.release", "ws.release.abort", "ws.release.abort.commit", "ws.release.commit", "ws.released", "ws.renew", "ws.sleep", "ws.snapshot", "ws.snapshot.commit", "ws.wake",
}
