...
func TestRunValidatesBeforeDialing(t *testing.T) {
	...
	cases := []struct {
		...
		{"repo malformed", []string{"custom", "--repo", "https://x/y.git", "--", "true"}, "owner/name"},
		{"repo bad ref", []string{"custom", "--repo", "github.com/o/r@-x", "--", "true"}, "valid git ref"},
		{"repo and dir", []string{"custom", "--repo", "github.com/o/r", "--dir", ".", "--", "true"}, "mutually exclusive"},
